...
<div class="row">
    ...
    <div class="row">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <br />
            <button type="submit" name="editarArticulo" class="btn btn-success float-left"><i class="bi bi-person-bounding-box"></i> Editar Publicacion</button>

            <button type="submit" name="borrarArticulo" class="btn btn-danger float-right"><i class="bi bi-person-bounding-box"></i> Borrar Publicacion</button>
            </form>
        </div>
    </div>
